...
const Footer = () => {
  return (
    <div className="w-full h-screen bg-zinc-900 p-20 flex">
      <div className="flex h-full justify-between items-start w-1/2 flex-col">
        <div className="heading">
          <h1 className="font-semibold text-[7.4vw] uppercase leading-none tracking-tighter ">
            Eye-
          </h1>
          <h1 className="font-semibold text-[7.4vw] uppercase leading-none tracking-tighter">
            opening
      ...
      <div className="w-1/2">
        ...
        <div className="max-w-6xl mx-auto   flex flex-col gap-8 pt-15 ">
          {/* Social Links */}
          <div>
          ...
          <div className="mt-10 flex gap-104">
            {/* Locations */}
            <div>
              ...
              <ul className="space-y-4 mt-2">
                <li>
                  ...
                  <p className="underline">Vancouver, Canada</p>
                </li>
                <li>
                  <p>30 Chukarina St</p>
