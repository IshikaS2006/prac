...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="logo">
        <h1 className="text-2xl md:text-3xl font-semibold tracking-wide uppercase bg-gradient-to-r from-blue-400 to-purple-600 text-transparent bg-clip-text">
          NeoVision
        </h1>
      </div>
        ...
        {["Home", "Projects", "About Me", "Skills", "Contact"].map(
          (item, index) => (
            <a
              ...
              className={`relative text-md lg:text-md font-light hover:text-blue-400 transition-colors duration-300 ${
                index === 4
